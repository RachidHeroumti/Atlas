<template>
  <div class="bg-gray-900 text-gray-50 md:py-5 px-5">
    ...
    <div
      id="madeby"
      class="bg-gray-900"
      style="padding: 0.5em; color: white; text-align: center"
    >
      <small
        >Made by
        <a style="color: #03a9f4" href="//www.storeino.com/" target="_blank"
          >Storeino.com</a
        ></small
      >
    </div>
