<template >
  <div class=" bg-white mt-16 sm:mt-0 w-full shadow  overflow-y-scroll">
  ...
  <!-- if Product List empty -->
    ...
    <div class="flex justify-end" v-if="section.show_more_text&&items.length>6">
      <nuxt-link class="py-2 px-4 w-full font-poppins text-white-gray text-base font-normal " :to="section.show_more_url">
