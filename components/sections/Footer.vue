  ...
  <div class="bg-white">
    <div class=" ">
      <div class="flex flex-wrap">
        ...
        >
          <p class="" v-html="$settings.sections.footer.email"></p>
          <p class="" v-html="$settings.sections.footer.phon"></p>
        </div>
      </div>

      <div
        v-if="$settings.sections.header.icons.social"
        class="w-full my-3 space-y-2"
      >
        ...
        <div class="flex flex-wrap space-x-1">
          <div
            v-for="item in methods.filter(
              (m) => $settings.sections.footer.methods[m.name]
            )"
            :key="item.name"
    ...
    return {
      methods: [
        ...
        },
        {
          name: "cash",
          image:
            "https://www.svgrepo.com/show/308983/cash-payment-pay-money-cash.svg",
        },
      ],
      socialMedia: [
        {
