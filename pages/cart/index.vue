<template>
    <div class=" mt-16 w-full">
        <div class=" image-background w-full">
            ...
            <div class="flex flex-col cart-items bg-white py-10">
                ...
                <div class=" grid grid-cols-4 w-full  text-gray-900 px-2 md:px-5 xl:px-10 ">
                 <h1 class=" font-poppins font-bold text-base text-center">Product</h1>
                  <h1 class=" font-poppins font-bold text-base text-center">Price</h1>
                   <h1 class=" font-poppins font-bold text-base text-center">Quantty</h1>
                    <h1 class=" font-poppins font-bold text-base text-center">SubTotal</h1>
                 </div>
            ...
            <div v-if="!loading.cart && items.length > 0" class="flex flex-col mb-2 shadow sm:p-5 p-2 bg-white  ">
                <div class=" py-3 p-1  bg-white  items-center border-t border-b border-gray-200 grid grid-cols-2 md:grid-cols-4 w-full  text-gray-900 px-2  md:px-5 xl:px-10 ">
                        
                        <h2 class="font-poppins font-bold text-base text-gray-600 w-full text-center ">{{ $settings.sections.cart.total_text }}</h2>
                        <h2 class=" font-poppins font-bold text-base  text-black text-center w-full ">{{ total }} {{ $store.state.currency.symbol }}</h2>
                <h1></h1>
                <h1></h1>
                ...
                <div class="flex justify-end w-full p-1 sm:p-2 items-center">
                   ...
                   <!-- <nuxt-link to="/shop" class="flex items-center justify-center w-1/2 p-2 text-2xl bg-gray-200 md:w-auto">
                    ...
                    <a href="/checkout2" class="flex items-center justify-center w-1/2 p-2  font-base  text-white whitespace-nowrap md:w-auto  hover:text-titles-color hover:bg-white border border-dark-gray  ai-c click-effect bg-titles-color">
                     <span>&ensp;</span>
                        <!--  -->
