          ...
          <div class="w-full lg:w-1/4 p-2 md:hidden">
            ...
            >
              <si-image
                width="100"
                height="100"
                class="w-20 h-20 sm:w-24 sm:h-24 m-1 cursor-pointer"
                v-for="(image, index) in item.images"
                @click="setImage(index)"
                :key="index"
                :src="image.src"
      ...
      <div class="w-full lg:w-1/2 px-8 ">
        <div class="p-2 flex h-full">
          <div class="">
            ...
            <div
              v-else
              class="flex w-full sm:flex-wrap md:flex-nowrap space-x-2 z-50 sm:z-auto fixed bottom-0 left-0 bg-white sm:static"
            >
              <div
            ...
            <div class="flex text-sm ">
              <button
                ...
                title="Wishlist"
                class="justify-center p-2 m-2 mx-1 rounded-md item top-1 right-2"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
                  ...
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  class="w-3 h-3 text-red-600 translate"
                >
                  <path
                    fill="currentColor"
              ...
              <button
                ...
                @click="addToWishlist"
                title="Wishlist"
                class="p-2 m-2 mx-1 rounded-md item top-1 right-2"
              >
                <svg
                  aria-hidden="true"
                  focusable="false"
              ...
              <button @click="toggleWishlist(item)" class="">
                <span
                  class="font-poppins text-12p font-base h-full text-center"
                >
                  {{
