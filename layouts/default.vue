<template>
  ...
  <template v-if="$route.name !== 'index'">
      ...
      @click="scrollToTop"
      class="fixed   z-50 right-5 text-white bg-gray-400 hover:bg-titles-color w-12 h-10 font-poppins font-normal text-base md:flex items-center justify-center"
    >
